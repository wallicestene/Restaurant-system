import { AggregateResult, Aggregation, Caller, CollectionDecorator, CollectionSchema, DataSourceDecorator, Filter, PaginatedFilter, Projection, RecordData, RelationSchema } from '@forestadmin/datasource-toolkit';
